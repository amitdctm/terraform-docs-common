...
To create, edit, and apply organization-owned variable sets, you must be part of a team with [**Manage all workspaces**](/terraform/cloud-docs/users-teams-organizations/permissions#manage-all-workspaces) or [**Manage all projects**](/terraform/cloud-docs/users-teams-organizations/permissions#manage-all-projects) permissions.
...
* [**Manage variable sets**](/terraform/cloud-docs/users-teams-organizations/permissions#general-project-permissions) project permission
